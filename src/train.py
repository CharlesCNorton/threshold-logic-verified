...
def train_single(
    ...
    for epoch in range(epochs):
        ...
        out_logits = torch.logit(out.clamp(1e-6, 1 - 1e-6))
...
def main():
    ...
    parser.add_argument('--l1', type=float, default=0.001, help='L1 regularization weight')
    parser.add_argument('--grad-clip', type=float, default=1.0, help='Gradient clipping norm')
    parser.add_argument('--start-temp', type=float, default=1.0, help='Starting temperature')
